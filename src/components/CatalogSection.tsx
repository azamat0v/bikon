      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            <h2
              style={{
                ...
                letterSpacing: '-0.04em', lineHeight: 1.06, color: '#111827',
                fontFamily: '"Inter", var(--font-sans), sans-serif', marginBottom: 20,
              }}
            >
              <span style={{ fontWeight: 300, color: '#9CA3AF' }}>{c.title_light}</span>
              {c.title_bold}
            </h2>
            ...
            <motion.a
              ...
              style={{
                ...
                letterSpacing: '-0.01em', padding: '14px 28px', borderRadius: 12,
                textDecoration: 'none', boxShadow: '0 4px 20px rgba(0,0,0,0.18)',
              }}
              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.boxShadow = '0 10px 32px rgba(0,0,0,0.28)'; }}
          ...
          <motion.div
            ...
            style={{ perspective: 1000, perspectiveOrigin: 'center center' }}
          >
            <div
              aria-hidden="true"
              style={{
                position: 'absolute', inset: '-12%',
                background: 'radial-gradient(ellipse 80% 70% at 50% 50%, rgba(232,219,252,0.55) 0%, rgba(212,239,255,0.35) 50%, transparent 80%)',
                filter: 'blur(32px)', zIndex: 0, pointerEvents: 'none',
              }}
            />
            <motion.div
              animate={{ rotateY: hovered ? 0 : -4, scale: hovered ? 1.05 : 1 }}
