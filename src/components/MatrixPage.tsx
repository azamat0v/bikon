...
export default function MatrixPage() {
  const { tr } = useLang();
  const l = (tr as unknown as { matrix: MatrixTr }).matrix;
...
───────────────────────────────────────────────────────────────────────── */
const WIN_APPS = [
  { label: 'Word',     bg: '#2B579A', icon: <svg viewBox="0 0 32 32" width="26" height="26"><path d="M3 3h12l2 3-2 3H3V3z" fill="#fff" fillOpacity=".9"/><path d="M3 9h12v8l-6 4-6-4V9z" fill="#fff" fillOpacity=".7"/><rect x="1" y="1" width="30" height="30" rx="4" fill="#2B579A"/><text x="16" y="22" textAnchor="middle" fill="white" fontSize="16" fontWeight="900" fontFamily="Arial">W</text></svg> },
